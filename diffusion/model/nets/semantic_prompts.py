...
# Adapted from IP-Adapter official resampler:
...
class SemanticSoftPromptAdapter(nn.Module):
    def __init__(
        self,
        encoder_name_or_path: str,
        num_tokens: int = 16,
        clip_input_res: int = 224,
    ):
        super().__init__()
        self.num_tokens = int(num_tokens)
        self.clip_input_res = int(clip_input_res)
        self.image_encoder = CLIPVisionModelWithProjection.from_pretrained(encoder_name_or_path)
