        ...
        for i, batch in enumerate(pbar):
            ...
            with torch.autocast(device_type="cuda", dtype=COMPUTE_DTYPE):
                ...
                guard_stats = {
                    ...
                    "hpa_text_out_std": float(sem_stats.get("hpa_text_out_std", 0.0)),
                    "hpa_img_out_std": float(sem_stats.get("hpa_img_out_std", 0.0)),
            ...
            if i % 10 == 0:
                ...
                log_dict = {
                    ...
                    'hpa_tstd': f"{hpa_text_out_std:.4f}",
                    'hpa_istd': f"{hpa_img_out_std:.4f}",
